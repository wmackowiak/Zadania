...
zen_bz_gw = zen.replace("*","")
print(zen_bz_gw)

print(zen_bz_gw.count('explain'))
print(zen_bz_gw.find("explain"))
print(zen_bz_gw.rfind("explain"))
zen_bz_gw_bz_ex1 = zen_bz_gw.replace("explain","understand",1)
print(zen_bz_gw_bz_ex1)
print(zen_bz_gw_bz_ex1.replace(" ","-"))